...
# GOAL: Get first and Last Digit of every line
# Go through Every Character, Look for integers
def int_search(line):
    """Searches for the first and last integer in a line of text"""
    ...
    # 123567
    final_number = final_number[0] + final_number[-1]
    return final_number
